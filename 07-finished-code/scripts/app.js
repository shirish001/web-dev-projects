...
let currentRound = 1; // to check which round it was , will be helpful in we have a draw
...
const gameOverArticleEle = document.getElementById("game-over"); // to display it after game finishes
